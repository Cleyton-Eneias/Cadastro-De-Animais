    ...
    <div id="divs2" style="border: solid 1px #332B47">
      ...
      <div id="div3">
        ...
        <div class="container">
          ...
          <form:form for="disabledTextInput" method="POST" modelAttribute="animal">
            <div class="mb-3">
            	<p><p class="badge bg-success text-wrap">${mensagem}</p></p>
              ...
              <br>
              <p class="text-end">
              <a class="btn btn-secondary btn-lg" href="animaiscadastrados">Visualizar cadastrados</a>
              <span><form:button class="btn btn-primary btn-lg">Cadastrar</form:button></span>
              </p>
            </div>
          </form:form>
        </div>
